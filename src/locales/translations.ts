export const translations = {
  en: {
    hero: {
      title: "Hello, I'm Ayaka Kojima",
      role1: "FRONT-END DEVELOPER",
      role2: "UI DESIGNER",
      description:
        "As a Front-End Developer with over 4 years of experience and a background as a graphic designer for 4+ years, I combine technical expertise with a strong design sensibility to create user-friendly and visually engaging digital experiences.",
      contact: "LinkedIn",
    ...
    summary: {
      ...
      experience: [
        "4+ years as a Designer & 4+ years as a Front-End Developer",
    ...
    projects: [
      ...
      },
      {
        ...
        images: [
          "/assets/images/project/protein-01.jpg",
          "/assets/images/project/protein-02.jpg",
          "/assets/images/project/protein-03.jpg",
          "/assets/images/project/protein-04.jpg",
          "/assets/images/project/protein-05.jpg",
        ],
        description:
  ...
  ja: {
    hero: {
      ...
      role2: "UI DESIGNER",
      description:
        "フロントエンド開発とデザインの両面に強みを持つフロントエンドエンジニアです。デザイナーとしての経験を活かし、ReactやTypeScriptを用いて直感的で使いやすいUIを提案・実装してきました。技術とデザインの両方を深く理解し、実用的で魅力的なプロダクトを構築することで、プロジェクトの成功に貢献します。",
      contact: "Wantedly",
    ...
    projects: [
      {
        id: 1,
        title: "SaaSプラットフォームのフロントエンド開発＆UIデザイン",
        category: ["React", "TypeScript", "Figma"],
        images: ["/assets/images/project/yoom-01.png", "/assets/images/project/yoom-02.png"],
        description:
          "ReactとTypeScriptを使用し、SaaSプラットフォームのユーザー中心の機能と直感的なUIの改善を実施しました。<br /> <br />💡 ハイライト <br />- コメントシステムにメンション機能を実装し、ユーザーの利便性を向上。これによりプレミアムプラン登録率が4%増加 <br />- 冗長なコードをリファクタリングし、新機能の開発時間を60%短縮 <br />- E2Eテストを作成・維持し、リリース後のバグを20%削減 <br />- ステークホルダーと協力し、FigmaでUI改善を設計。ユーザー体験を大幅に向上",
      },
      {
        id: 3,
        title: "企業向けコーポレートサイトのフロントエンド開発",
        category: ["Nuxt", "Vue.js", "JavaScript"],
        images: ["/assets/images/project/leverage-01.png"],
        description:
          "企業チームと協力し、プロフェッショナルで魅力的なオンラインプレゼンスを確立するためのWebサイト改善を行いました。<br /> <br />📌 プロジェクト要件 <br />- モダンでレスポンシブなコーポレートサイトの構築 <br />- Nuxt、Vue、JavaScriptを活用したインタラクティブなサイト設計 <br />- スムーズなナビゲーションとパフォーマンスの最適化 <br /> <br />💡 ハイライト <br />- クライアントのブランドイメージを的確に表現するダイナミックなWebサイトを構築 <br />- シームレスなナビゲーションとレスポンシブデザインを実装し、さまざまなデバイスでのユーザー体験を向上 <br />- サイトのパフォーマンスを改善し、読み込み速度を向上させ、ユーザーエンゲージメントを強化",
      },
      {
        id: 2,
        title: "D2C ECサイトのフロントエンド開発",
        category: ["WordPress", "HTML", "SCSS"],
        images: ["/assets/images/project/valx-01.png"],
        description:
          "D2C向けECサイトのフロントエンド開発を担当し、ユーザー体験の向上に貢献しました。<br /> <br />💡 ハイライト <br />- ユーザーインタラクションを重視したデザインと機能を実装 <br />- サイトの読み込み速度とパフォーマンスを向上 <br />- ブランドの世界観を反映し、視覚的に魅力的なデザインを作成",
      },
      {
        id: 4,
        title: "フィットネスアプリのUIデザイン",
        category: ["Figma", "Photoshop", "Illustrator"],
        images: ["/assets/images/project/gymapp-01.png", "/assets/images/project/gymapp-02.png"],
        description:
          "ユーザーにとって魅力的で使いやすいフィットネスアプリのUIデザインを作成しました。<br /> <br />💡 ハイライト <br />- 視覚的に魅力的で直感的なUIデザインを作成し、ユーザーエンゲージメントを向上 <br />- 幅広いユーザー層に対応するレスポンシブ＆アクセシブルなデザインを開発 <br />- ステークホルダーと協力してデザインを改善し、より使いやすいアプリを実現",
      },
      {
        id: 5,
        title: "プロテインサプリメントのパッケージデザイン",
        category: ["Illustrator", "Photoshop"],
        images: [
          "/assets/images/project/protein-01.jpg",
          "/assets/images/project/protein-02.jpg",
        ...
        description:
          "女性向けプロテインサプリメントのブランドパッケージをデザインし、視覚的に魅力的でユーザーフレンドリーなデザインを作成しました。<br /> <br />💡 ハイライト <br />- ブランドのアイデンティティを反映した洗練されたパッケージデザイン <br />- 目を引くビジュアルで市場競争力を向上 <br />- パッケージのユーザビリティを考慮し、開封しやすいデザインを設計",
      },
      {
        id: 6,
        title: "高級レストラン向けメニューデザイン",
        category: ["Canva", "Photoshop"],
        images: ["/assets/images/project/menu-01.png", "/assets/images/project/menu-02.png"],
        description:
          "高級バー＆ダイニングのための洗練されたモダンなメニューをデザインしました。<br /> <br />💡 ハイライト <br />- Canvaを活用し、クライアントが自分でメニュー更新できる仕組みを導入 <br />- Canvaのグループ化機能を活用し、テキストや要素の調整をスムーズに <br />- 一貫性を保つためのガイドラインを提供し、将来的な更新の容易さを確保",
      },
    ],
    experiences: [
      {
        ...
        title: "フロントエンドエンジニア",
        company: "Yoom株式会社",
        period: "2023年2月 - 2024年6月",
        details: [
          "ReactとTypeScriptを使用してYoomのSaaSプラットフォームの主要機能を設計・実装し、ユーザーオンボーディング率を33%向上。",
          "コメントシステムにメンション機能を導入し、ユーザーの利便性を向上させ、プレミアムプラン登録率を4%向上。",
          "Figmaを活用してUI改善を提案・設計し、ステークホルダーとのコラボレーションとユーザー体験を向上。",
          "コードのリファクタリングを実施し、冗長性を排除することで、新機能の開発時間を60%削減。",
          "E2Eテストの開発・保守を行い、安定性を確保し、リリース後のバグを20%削減。",
        ],
        images: ["/images/yoom1.png", "/images/yoom2.png", "/images/yoom3.png"],
      },
      {
        id: 2,
        title: "フロントエンドエンジニア",
        company: "Leverage株式会社",
        period: "2020年2月 - 2023年1月",
        details: [
          "再利用可能なReactコンポーネントを設計・実装し、複数のプロジェクトでの開発効率を向上。",
          "ヨガブランドのECサイトをWordPressで開発・公開し、納期通りにリリース。",
          "Figmaを活用してステークホルダーと連携し、UIデザインの一貫性を確保。",
          "SEO戦略を最適化し、Webパフォーマンスを改善することで、オーガニックトラフィックを20%増加。",
          "包括的なドキュメントを作成し、知識共有を促進するとともに、ジュニアエンジニアの指導を実施。",
        ],
        images: ["/images/leverage.png"],
      },
      {
        id: 3,
        title: "グラフィックデザイナー & UIデザイナー",
        company: "Toikatsu合同会社",
        period: "2018年10月 - 2020年1月",
        details: [
          "直感的なモバイルジム管理アプリのUIを設計・開発し、体重管理やインストラクターレビュー機能を搭載。15,000人のユーザーのエンゲージメントを向上。",
          "女性向けプロテインブランドのパッケージデザインを制作し、全国40店舗以上で販売。",
        ],
      },
      {
        id: 4,
        title: "グラフィックデザイナー",
        company: "KOYAMA株式会社",
        period: "2016年4月 - 2018年9月",
        details: [
          "教育機関や医療施設向けのブランディングおよびサインデザインを制作し、クライアントの要望に沿ったデザインを実現。",
        ],
      },
    ],
  },
